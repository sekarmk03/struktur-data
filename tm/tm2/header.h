...
void addFirst(char name[], char formula[], char concent[], list *L); // menambah 1 elemen di awal list
void addAfter(element* prev, char name[], char formula[], char concent[], list *L); // menambah 1 elemen setelah elemen tertentu
void addLast(char name[], char formula[], char concent[], list *L); // menambah 1 elemen di akhir list
